function E_cell_out = reduce_component_2_etopes_cell(E_cell_in,n_rdc)
% E_cell_out = reduce_component_2_etopes_cell(E_cell,n_gen_to_remove)
%
% Given a list of basic 2-ellipsotopes E_cell, create a minimum-volume
% outer ellipsoid to eliminate n_gen_to_remove generators. The default of
% n_gen_to_remove is 1.
%
% The output is a list of basic 2-ellipsotopes.
%
